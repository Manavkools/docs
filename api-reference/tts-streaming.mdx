...
Tabbly TTS provides a streaming Text-to-Speech API that bridges to Inworld AI's TTS service. This API allows you to generate high-quality voice audio in real-time for your voice AI applications.
...
<ParamField body="model_id" type="string" default="inworld-tts-1">
...
- Learn how to integrate with LiveKit: [LiveKit Integration](/api-reference/tts-livekit-integration)
