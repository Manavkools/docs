...
This guide explains how to integrate Tabbly TTS API with LiveKit Agents for voice AI applications. Tabbly TTS provides a streaming Text-to-Speech API that bridges to Inworld AI's TTS service, allowing you to use Tabbly TTS as a TTS provider in your LiveKit voice agents.
...
async def entrypoint(ctx: agents.JobContext):
    ...
    tabbly_tts = TabblyTTS(
        ...
        model_id="inworld-tts-1",  # Optional, defaults to "inworld-tts-1"
    )
...
<ResponseField name="model_id" type="string" default="inworld-tts-1">
  Model ID to use (default: "inworld-tts-1")
</ResponseField>
...
- Check [TTS Streaming API documentation](/api-reference/tts-streaming)
